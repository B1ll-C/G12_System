...
LOCK TABLES `bev` WRITE;
/*!40000 ALTER TABLE `bev` DISABLE KEYS */;
INSERT INTO `bev` VALUES ('BC','Coke (1.5)',75.00,'13.jpg'),('BP','Pepsi(1.5)',75.00,'14.jpg');
/*!40000 ALTER TABLE `bev` ENABLE KEYS */;
UNLOCK TABLES;
